...
export default function Home() {
  return (
    <>
      <h2>타닥</h2>
      <Image src="/IMEAppIcon.png" width="100" height="100" alt="App icon" className="my-4 mx-auto sm:m-0 sm:ml-4 sm:float-right" />
      ...
      <div className="my-4">
        ...
        >macOS 버전 다운로드</a>
        <span className="ml-4 text-sm text-gray-500 dark:text-zinc-400">버전 0.1.2</span>
      </div>
      <p className="text-sm text-gray-500 dark:text-zinc-400">macOS 26.0 이상 지원. Intel Mac과 Apple Silicon Mac을 모두 지원합니다.</p>
      <h3>다양한 배열 지원</h3>
      ...
      <ul className="pl-8 my-2 list-disc">
        ...
        <li>모아치기가 적용된 세벌식 배열: 세모이 (세벌식 모아치기 e), 안마태 소리 글판을 지원합니다.</li>
        <li>기호 확장이 적용된 배열: 세모이 (세벌식 모아치기 e), 신세벌식 P2를 지원합니다.</li>
      </ul>
